...
// under the License.
package com.fishep.flink.cdc.converter;
...
public class DateToStringConverter implements CustomConverter<SchemaBuilder, RelationalColumn> {
  ...
  static {
    ...
    DEFAULT_PROPS.setProperty("date.type", "com.fishep.flink.cdc.converter.DateToStringConverter");
...
//    DEFAULT_PROPS.setProperty("include.schema.comments", "true");
  }
