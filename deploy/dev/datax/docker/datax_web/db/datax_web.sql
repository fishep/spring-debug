...
USE datax_web;
CREATE USER 'datax_web' IDENTIFIED BY 'datax_web';
GRANT ALL ON datax_web.* TO datax_web;
ALTER USER 'datax_web'@'%' IDENTIFIED WITH 'mysql_native_password' BY 'datax_web';
FLUSH PRIVILEGES;
